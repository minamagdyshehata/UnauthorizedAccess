...
if GMAIL_LSA != "": RAWUA[83] = "            email = "+ chr(34) + GMAIL_LSA + chr(34) + "\n"
if GMAIL_LSA_PASS != "": RAWUA[84] = "            password = "+ chr(34) + GMAIL_LSA_PASS + chr(34 )+ "\n"
if NOFITY_EMAIL != "": RAWUA[85] = "            send_to_email = "+ chr(34) + NOFITY_EMAIL + chr(34) + "\n"
if TERMINATION_PASS != "": RAWUA[130] = "        if auth == "+ chr(34) + TERMINATION_PASS + chr(34) + " and Notification_Timer_on:" + "\n"
if MODE == "2":
    RAWUA[96] ="\n"
    RAWUA[133] ="\n"
    RAWUA[134] ="\n"
